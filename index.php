            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <p class="text-muted"><span class="typewrite d-inline" data-period="2000" data-type='[ " Desarrollador Web. " ]'></span></p>
                        <h4 class="mb-20"> Hola</h4>
                        <h2>I'm <span>Jean</span></h2>
                        <h5 class="text-muted">Accede a todos los proyectos que requieras</h5>
                    </div>
                    ...
                    <div class="row align-self-center">
                        ...
                        <div class="col-md-8 text-md-right font-small align-self-center">
                            ...
                            <ul class="list-inline d-inline-block tags">
                                ...
                                <li class="list-inline-item"><a href="#"># Java</a></li>
